  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <h4 className="text-lg font-bold text-emerald-700 dark:text-emerald-200">
          📈 Profit Over Time
        </h4>
      ...
      {(!Array.isArray(entries) || entries.length === 0) && (
        <p className="text-text-muted text-center mt-10">No betting history to display chart.</p>
      )}
